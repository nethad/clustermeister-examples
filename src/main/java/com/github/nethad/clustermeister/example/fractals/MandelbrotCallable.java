 ...
 * @author thomas
 */
public class MandelbrotCallable implements Callable<MandelbrotResult>, Serializable {
    private final int b;
    private final FractalConfiguration config;

    public MandelbrotCallable(final int b, FractalConfiguration configuration) {
        this.b = b;
        this.config = configuration;
    }

    public MandelbrotResult call() throws Exception {
